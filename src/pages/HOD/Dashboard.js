											...
											<div className="card-body p-3">
												<div className="media">
													<div className="media-body">
														<p style={{ color: "#000", fontSize: "12px" }} className="mb-0">Total Applicants</p>
									...
									<Link to={{ pathname: "/admin/applicants" }}>
										<div className="card flex-fill">
											<div className="card-body p-3">
												<div className="media">
													<div className="media-body">
														<p style={{ color: "#000", fontSize: "12px" }} className="mb-0">Number of Applicants Today</p>
									...
									<Link to={{ pathname: "/admin/applicants" }}>
										<div className="card flex-fill">
											<div className="card-body p-3">
												<div className="media">
													<div className="media-body">
														<p style={{ color: "#000", fontSize: "12px" }} className="mb-0">Applicants with PVC</p>
