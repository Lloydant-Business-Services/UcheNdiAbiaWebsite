...
loadUsersByPVC = (data) => {
	...
	render() {
		...
		return (
			<>
			<Drawer width={isMobile ? "93vw" : 640} placement="right" closable={true} onClose={this.onClose} visible={this.state.showDraw}>
		...
		<Row>
          <Col span={24}>
            {/* <DescriptionItem title="Full Name" content={this.state.personName} /> */}
			<img src={this.state.passportUrl} style={{width:"50px"}}/>
          </Col>
        ...
        <Row>
          ...
          <Col span={12}>
            <DescriptionItem style={{fontSize:"12px"}} title="Email" content={this.state.email} />
          </Col>
        </Row>
		<br/>
        <Row>
          <Col span={12}>
            <DescriptionItem title="Phone" content={this.state.phoneNumber} />
          </Col>
          <Col span={12}>
		  <DescriptionItem title="Gender" content={this.state.gender} />
        ...
        <Row>
          <Col span={12}>
            <DescriptionItem title="Date of birth" content={this.state.dateOfBirth} />
          </Col>
          <Col span={12}>
            <DescriptionItem title="Applied on" content={this.state.createdDate} />
        ...
        <Row>
          <Col span={12}>
            <DescriptionItem title="Highest Edu. Qualification" content={this.state.higestQualification} />
          </Col>
		  {/* <br/> */}
          <Col span={12}>
            <DescriptionItem title="Has PVC?" content={this.state.hasPvc} />
          </Col>
        </Row>
		<br/>
        ...
        <Divider />
        <p className="site-description-item-profile-p">Soial Media Handles</p>
        <Row>
          <Col span={24}>
            <DescriptionItem title="Facebook" content="AntDesign@example.com" />
          </Col>
		  <br/>
		  <br/>
		  <Col span={24}>
            <DescriptionItem title="Twitter" content="AntDesign@example.com" />
          </Col>
		  <br/>
		  <br/>
		  <Col span={24}>
            <DescriptionItem title="Instagram" content="AntDesign@example.com" />
          </Col>
