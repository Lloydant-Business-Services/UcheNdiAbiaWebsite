        ...
        <>
            ...
            <div className="min-vh-100">
                ...
                <div className="bg-sky" style={isMobile ? { padding: "40px" } : { padding: "63px" }}>
                        ...
                        <>
                            <div class="card" style={{ width: '300px', height: '200px', marginLeft: '20px' }}>
                                ...
                                <iframe
                                    width="100%"
                                    height="315"
                                    src={"https://www.youtube.com/embed/FdFVlKvuckI"}
                    ...
                    <center style={{ color: "#0000009c" }}>
                        <i className="fa fa-angle-left" /> &nbsp; &nbsp; Swipe for more &nbsp; &nbsp;  <i className="fa fa-angle-right" />
                    </center>
                </div>

                <div className="bg-sky" style={isMobile ? { padding: "40px" } : { padding: "63px" }}>
                    <h2 className="monte">News</h2>
                    <br />
                    <br />
                    <div className="row">
                        ...
                        {mainNewsArr && mainNewsArr.map((x) => {
                            ...
                            return (
                                <>
                                    ...
                                    <div className="col-sm-12 col-lg-3" onClick={() => handleNewsOpen(x)}>
                                        <Card sx={{ maxWidth: 345 }} style={isMobile ? { marginTop: "30px" } : null}>
                                            <CardHeader
                                                ...
                                                title={x.title.length > 30 ? x.title.substring(0, 30).toUpperCase() + "..." : x.title.toUpperCase()}
                                                subheader={x.createdDate != null ? x.createdDate.substring(0,10) : "-"}
                                            />
                                            <CardMedia
                                                component="img"
                                                height="400"
                                    ...
                                    {/* <div className="col-sm-12 col-md-4" style={isMobile ? { marginBottom: "20px", flex:"0 0 200px" } : null}>
                                       <img src={x.mainImage?.asset?.url}/>
...
export default connect(mapStateToProps, mapDispatchToProps)(NativeMedia);
