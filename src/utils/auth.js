...
export function getUserToken() {
    return getActiveStore().getItem("UCHE_NDI")
}
...
export function getUser(key, defaultValue = null) {
    ...
    const userData = getActiveStore().getItem("UCHE_NDI");
...
export function loginUser(user) {
    ...
    if (user) {
        storage.setItem("UCHE_NDI", JSON.stringify(user));
...
export function logOutUser(redirect) {
    ...
    localStorage.removeItem("UCHE_NDI");
